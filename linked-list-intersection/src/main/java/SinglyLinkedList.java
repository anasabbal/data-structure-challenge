...
public class SinglyLinkedList {
    ...
    private PairNode generateTwoLinkedListWithIntersection(){
    ...
    private PairNode generateLinkedList(int size2) {
        head = null;
        tail = null;
    ...
    public int intersection(){
        ...
        PairNode pair = generateTwoLinkedListWithIntersection();
